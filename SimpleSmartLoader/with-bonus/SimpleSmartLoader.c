...
void sigsegv_handler(int signum, siginfo_t* info, void* context){
    ...
    void* allocated_memory = mmap((void*)(temp.p_vaddr + (uintptr_t)offset*PAGESZ) ,
        PAGESZ,
